...
<div id = "pages">
	<?php if($page > 1):?>
	<a href="?page=<?php echo $this->escape($page-1);?>">前へ</a>
<?php endif;?>
	<?php for ($i = 1;$i <= $totalPages;$i++):?>
		<?php if($page === $i):?>
			<a href="?page=<?php echo $i;?>"><?php echo $this->escape($i);?></a>
		<?php else: ?>
			<a href="?page=<?php echo $this->escape($i);?>"><?php echo $this->escape($i);?></a>
		<?php endif;?>
	<?php endfor;?>

<?php if($page < $totalPages):?>
	<a href="?page=<?php echo $this->escape($page +1);?>">次へ</a>
<?php endif;?>
</div>
